...
var totalSeconds = 15 * 60; // 15 minutes
...
function displayVictoryMess(moves) {
  clearInterval(timer);
  var victoryMessage = "You Moved " + moves + " Steps. Time taken: " + getTimerValue();
  document.getElementById("moves").innerHTML = victoryMessage;
  toggleVisibility("Message-Container", null);
}
function closeCard(){
...
window.onload = function () {
  ...
  sprite = new Image();
  sprite.src = "static/img/player.png";

  finishSprite = new Image();
  finishSprite.src = "static/img/food.png";
};
...
function sendTimerValue(timerValue) {
  $.ajax({
      type: "POST",
      url: "/finished",
...
function displayVictoryMess(moves) {
  ...
  var victoryMessage = "You Moved " + moves + " Steps. Time taken: " + timerValue;
  document.getElementById("moves").innerHTML = victoryMessage;
